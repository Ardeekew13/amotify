...
// 	const buttonPermission = useMemo(() => {
// 		const expense = data?.getExpenseById?.expense;
...
// 			isCurrentUserPaid,
// 			canEdit:
// 				(isNewExpense || isPaidByCurrentUser) &&
// 				!someoneAlreadyPaid &&
// 				!isCompleted,
// 			canMarkAsPaid: expense?._id && !isPaidByCurrentUser && !isCompleted,
// 		};
// 	}, [data, user]);

// 	const renderSubmitButton = () => {
// 		if (!buttonPermission.canEdit) return null;

// 		const isLoading = upsertLoading || isUploading;
// 		const buttonText = buttonPermission.isNewExpense
// 			? "Add Expense"
// 			: "Update Expense";
// 		const loadingText = buttonPermission.isNewExpense ? "Creating" : "Updating";
...
// 		if (!buttonPermission.canMarkAsPaid) return null;

// 		return (
// 			<Button onClick={() => handleMarkAsPaid()}>
// 				{buttonPermission.isCurrentUserPaid ? "Mark as Unpaid" : "Mark as Paid"}
// 			</Button>
// 		);
// 	};
...
// 						{buttonPermission.isNewExpense ? null : (
// 							<Badge
// 								variant={
// 									data?.getExpenseById?.expense?.status ===
...
// 						multiple={true}
// 						maxFiles={5}
// 						someoneAlreadyPaid={buttonPermission.someoneAlreadyPaid ?? false}
// 					/>
// 				</div>
